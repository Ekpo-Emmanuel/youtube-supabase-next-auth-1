            ...
            <div className="max-w-md mx-auto md:max-w-sm md:w-96">
                ...
                <div className="pt-10">
                    <div className='flex flex-col gap-3 mt-2'>
                        <button onClick={handleGoogleSignIn} className="inline-flex items-center justify-center w-full text-sm gap-3 px-[16px] py-[8px] font-medium duration-200 bg-gray-100 rounded-md hover:bg-gray-200 focus:ring-1 focus:ring-offset-1 focus:ring-gray-300" >
                            <FaGoogle />
